    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            ...
            <p className="text-grat-400 text-lg mb-8 max-w-lg mx-auto">
                I am a passionate Full-Stack Developer specializing in building modern, responsive web applications using React, Tailwind CSS, and ASP.NET Core. I love crafting seamless user experiences and robust backend solutions.
            </p>
